...
const Header = ({ toggle, user }) => {
	...
	return (
		<AppBar color="transparent" className="root">
			<IconButton className="menuBtn" color="inherit" aria-label="menu" onClick={() => toggle()}>
				<MenuIcon />
			</IconButton>
			<LinkContainer exact={true} to="/">
				<Box className="title" display="flex" justifyContent="space-between" alignItems="center">
